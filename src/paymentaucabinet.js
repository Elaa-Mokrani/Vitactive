...
const [showPayment, setShowPayment] = useState(false);
 ...
 <Ionicons name="logo-apple" size={40} color="#858585" style={styles.paymentIcon} />
      ...
      <TouchableOpacity
        style={[styles.paymentMethod, styles.paymentCash]}
        onPress={() => handlePaymentSelect('paymentCash')}
      >
        {renderCheckmarkIcon('paymentCash')}
<Image
            source={require('../assets/png/wallet.png')}
            style={styles.image}
          />
        <Text style={styles.paymentText}>Payment Cash</Text>
      </TouchableOpacity>
      {/* Payer button */}
...
export default PaymentacScreen;
